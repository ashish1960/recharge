...
/**
 * Servlet implementation class registreController
 */
public class registreController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		register regobj= new register(email, name, lastname, password, mobileno);
