...
<!-- Modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-bs-whatever="@mdo" style="margin: 5px;">Login</button>
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
      <div class="tm">
        <form class="form" action="loginController">
    ...
    <label>
        <input required="" placeholder="Mobile no" type="password" class="input" name="password">
        
    </label>
    
    <button class="submit" value="registraion">Submit</button>
    <p class="signin">forgot password ? <a href="updatepassword.jsp">password</a> </p>
</form>
</div>
        </div>
       </div>
